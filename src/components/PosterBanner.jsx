      ...
      <div className="w-full h-full">
        ...
        <div className="absolute w-full top-[10%] lg:top-[25%] p-4 md:p-8">
          ...
          <div className="mt-8 mb-4">
            <button className="capitalize border bg-gray-500 py-2 px-5 text-black">
              play
            </button>
            <button className="capitalize border border-gray-500 py-2 px-5 ml-4">
              watch later
            </button>
          </div>
          <p className="text-gray-400 text-sm">{release_date}</p>
          <p className="w-full md:max-w-[70%] lg:max-w-[50%] xl:max-w-[35%] text-gray-200">
            {truncate(overview, 175)}
          </p>
        </div>
      </div>
    </div>
